package com.whayer.wx.upload.fileuploader.web.utils;
...
import com.whayer.wx.upload.fileuploader.exception.JavaFileUploaderException;
import com.whayer.wx.upload.fileuploader.exception.MissingParameterException;
import com.whayer.wx.upload.fileuploader.json.SimpleJsonObject;
...
public class FileUploaderHelper {
	...
	public FileUploadConfiguration extractFileUploadConfiguration(HttpServletRequest request)
		...
		System.out.println(is.available()>0 ? "输入流不为空":"输入流为空");
